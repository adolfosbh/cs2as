	...
	extends AbstractTargetCommonLookupVisitor
{
    ...
    public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_TargetUnqualifiedBLookupVisitor = PACKid_java_c_s_s_uk_ac_york_cs_asbh_lang_cs2as_target_util.getClassId("TargetUnqualifiedBLookupVisitor", 0);
    ...
    public /*@NonInvalid*/ LookupEnvironment visitA1(final /*@NonInvalid*/ uk.ac.york.cs.asbh.lang.cs2as.target.@org.eclipse.jdt.annotation.NonNull A1 element) {
        ...
        if (includes) {
            ...
            while (true) {
                ...
                /*@NonInvalid*/ uk.ac.york.cs.asbh.lang.cs2as.target.@org.eclipse.jdt.annotation.Nullable B x = (B)ITERATOR_x.next();
                /**
                 * _'<' : Boolean[1]
                 */
            ...
            @SuppressWarnings("null")
            final /*@Thrown*/ uk.ac.york.cs.asbh.lang.cs2as.target.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment inner = context.addElements((EList<B>)ECORE_select);
