...
/**
 * This is the item provider adapter for a {@link uk.ac.york.cs.asbh.lang.cs2as.target.C} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CItemProvider extends NamedElementItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TargetPackage.Literals.C__OWNS_D);
		}
	...
	public String getText(Object object) {
		String label = ((C)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_C_type") :
			getString("_UI_C_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TargetPackage.Literals.C__OWNS_D,
				 TargetFactory.eINSTANCE.createD()));
	}
