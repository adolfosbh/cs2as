...
import org.xtext.example.company.lookup.LookupFactory;
...
public class LookupPackageImpl extends EPackageImpl implements LookupPackage {
	 ...
	 * @see org.xtext.example.company.lookup.LookupPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	protected void createImportAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "target", "platform:/resource/org.xtext.example.companies/model/Company.ecore"
		   });
	}
	...
	protected void createPivotAnnotations() {
		...
		addAnnotation
		  (getLookupEnvironment__AddElement__Employee(), 
		   source, 
		   new String[] {
