 ...
 * from:
 *   /org.xtext.example.companies/model/Lookup.ecore
 * using:
 *   /org.xtext.example.companies/model/Lookup.genmodel
...
public class LookupTables
{
	...
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull NsURIPackageId PACKid_http_c_s_s_xtext_eclipse_org_s_example_s_companies_s_lookup = org.eclipse.ocl.pivot.ids.IdManager.getNsURIPackageId("http://xtext.eclipse.org/example/companies/lookup", null, org.xtext.example.company.lookup.LookupPackage.eINSTANCE);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_Employee = org.xtext.example.company.lookup.LookupTables.PACKid_http_c_s_s_www_company_com.getClassId("Employee", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_Executor = org.xtext.example.company.lookup.LookupTables.PACKid_http_c_s_s_xtext_eclipse_org_s_example_s_companies_s_lookup.getClassId("Executor", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull ClassId CLSSid_LookupEnvironment = org.xtext.example.company.lookup.LookupTables.PACKid_http_c_s_s_xtext_eclipse_org_s_example_s_companies_s_lookup.getClassId("LookupEnvironment", 0);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull CollectionTypeId BAG_CLSSid_LookupEnvironment = org.eclipse.ocl.pivot.ids.TypeId.BAG.getSpecializedId(org.xtext.example.company.lookup.LookupTables.CLSSid_LookupEnvironment);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull CollectionTypeId ORD_CLSSid_Employee = org.eclipse.ocl.pivot.ids.TypeId.ORDERED_SET.getSpecializedId(org.xtext.example.company.lookup.LookupTables.CLSSid_Employee);
	public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull PropertyId PROPid_namedElements = org.xtext.example.company.lookup.LookupTables.CLSSid_LookupEnvironment.getPropertyId("namedElements");
