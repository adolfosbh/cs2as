/**
 */
package org.xtext.example.plsql.astm.lookup;
 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.xtext.example.plsql.astm.lookup.LookupFactory
 * @model kind="package"
 *        annotation="http://www.eclipse.org/OCL/Import target='platform:/resource/org.xtext.example.plsql/model/astm.ecore'"
...
public interface LookupPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_URI = "http://xtext.eclipse.org/example/plsql/lookup";
	 ...
	 * @generated
	 */
	LookupPackage eINSTANCE = org.xtext.example.plsql.astm.lookup.impl.LookupPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.xtext.example.plsql.astm.lookup.impl.LookupEnvironmentImpl <em>Environment</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.xtext.example.plsql.astm.lookup.impl.LookupEnvironmentImpl
	 * @see org.xtext.example.plsql.astm.lookup.impl.LookupPackageImpl#getLookupEnvironment()
	 * @generated
	 */
	 ...
	 * @see org.xtext.example.plsql.astm.lookup.impl.LookupPackageImpl#getExecutor()
	 * @generated
	 */
	int EXECUTOR = 1;
	...
	/**
	 * Returns the meta object for the reference list '{@link org.xtext.example.plsql.astm.lookup.LookupEnvironment#getNamedElements <em>Named Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Named Elements</em>'.
	 * @see org.xtext.example.plsql.astm.lookup.LookupEnvironment#getNamedElements()
	...
	/**
	 * Returns the meta object for the reference '{@link org.xtext.example.plsql.astm.lookup.LookupEnvironment#getParentEnv <em>Parent Env</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Parent Env</em>'.
	 * @see org.xtext.example.plsql.astm.lookup.LookupEnvironment#getParentEnv()
	 * @see #getLookupEnvironment()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the '{@link org.xtext.example.plsql.astm.lookup.LookupEnvironment#addElements(java.util.Collection) <em>Add Elements</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Add Elements</em>' operation.
	 * @see org.xtext.example.plsql.astm.lookup.LookupEnvironment#addElements(java.util.Collection)
	 * @generated
	 */
	EOperation getLookupEnvironment__AddElements__Collection();

	/**
	 * Returns the meta object for the '{@link org.xtext.example.plsql.astm.lookup.LookupEnvironment#addElements(astm.Definition) <em>Add Elements</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Add Elements</em>' operation.
	 * @see org.xtext.example.plsql.astm.lookup.LookupEnvironment#addElements(astm.Definition)
	 * @generated
	 */
	EOperation getLookupEnvironment__AddElements__Definition();

	/**
	 * Returns the meta object for the '{@link org.xtext.example.plsql.astm.lookup.LookupEnvironment#hasFinalResult() <em>Has Final Result</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Has Final Result</em>' operation.
	 * @see org.xtext.example.plsql.astm.lookup.LookupEnvironment#hasFinalResult()
	 * @generated
	 */
	EOperation getLookupEnvironment__HasFinalResult();

	/**
	 * Returns the meta object for the '{@link org.xtext.example.plsql.astm.lookup.LookupEnvironment#getExecutor() <em>Get Executor</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the '<em>Get Executor</em>' operation.
	 * @see org.xtext.example.plsql.astm.lookup.LookupEnvironment#getExecutor()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.xtext.example.plsql.astm.lookup.impl.LookupEnvironmentImpl <em>Environment</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.xtext.example.plsql.astm.lookup.impl.LookupEnvironmentImpl
		 * @see org.xtext.example.plsql.astm.lookup.impl.LookupPackageImpl#getLookupEnvironment()
