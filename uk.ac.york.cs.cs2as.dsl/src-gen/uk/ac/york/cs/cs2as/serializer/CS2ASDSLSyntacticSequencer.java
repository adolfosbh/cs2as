...
public class CS2ASDSLSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_ScopeDef_NestedScopeKeyword_1_0_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_ScopeDef_NestedScopeKeyword_1_0_q = new TokenAlias(false, true, grammarAccess.getScopeDefAccess().getNestedScopeKeyword_1_0());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_ScopeDef_NestedScopeKeyword_1_0_q.equals(syntax))
				emit_ScopeDef_NestedScopeKeyword_1_0_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     (rule start) (ambiguity) contribution=ContributionDef
	 *     selectionDef=SelectionDef (ambiguity) alsoExports?='also-exports'
	 *     selectionDef=SelectionDef (ambiguity) contribution=ContributionDef
	 */
	protected void emit_ScopeDef_NestedScopeKeyword_1_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
