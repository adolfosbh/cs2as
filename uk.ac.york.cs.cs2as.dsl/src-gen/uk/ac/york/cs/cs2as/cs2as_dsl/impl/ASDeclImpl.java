 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.york.cs.cs2as.cs2as_dsl.impl.ASDeclImpl#getMetamodels <em>Metamodels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ASDeclImpl extends MinimalEObjectImpl.Container implements ASDecl
{
  ...
  public EList<ImportCS> getMetamodels()
  {
    if (metamodels == null)
    {
      metamodels = new EObjectContainmentEList<ImportCS>(ImportCS.class, this, Cs2as_dslPackage.AS_DECL__METAMODELS);
    }
    return metamodels;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Cs2as_dslPackage.AS_DECL__METAMODELS:
