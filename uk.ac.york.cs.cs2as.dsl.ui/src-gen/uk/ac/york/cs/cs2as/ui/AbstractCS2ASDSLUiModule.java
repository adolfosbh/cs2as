...
/**
 * Manual modifications go to {uk.ac.york.cs.cs2as.ui.CS2ASDSLUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractCS2ASDSLUiModule extends org.eclipse.xtext.common.types.ui.DefaultCommonTypesUiModule {
	
	public AbstractCS2ASDSLUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(uk.ac.york.cs.cs2as.parser.antlr.internal.InternalCS2ASDSLLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return uk.ac.york.cs.cs2as.ui.labeling.CS2ASDSLLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(uk.ac.york.cs.cs2as.ui.labeling.CS2ASDSLDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return uk.ac.york.cs.cs2as.ui.outline.CS2ASDSLOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return uk.ac.york.cs.cs2as.ui.quickfix.CS2ASDSLQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.ContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return uk.ac.york.cs.cs2as.ui.contentassist.CS2ASDSLProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return uk.ac.york.cs.cs2as.ui.contentassist.antlr.CS2ASDSLParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(uk.ac.york.cs.cs2as.ui.contentassist.antlr.internal.InternalCS2ASDSLLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(uk.ac.york.cs.cs2as.ui.contentassist.antlr.internal.InternalCS2ASDSLLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(uk.ac.york.cs.cs2as.ui.contentassist.antlr.internal.InternalCS2ASDSLLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.codetemplates.ui.partialEditing.IPartialContentAssistParser> bindIPartialContentAssistParser() {
		return uk.ac.york.cs.cs2as.ui.contentassist.antlr.PartialCS2ASDSLContentAssistParser.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.XtextEditor> bindXtextEditor() {
		return uk.ac.york.cs.cs2as.ui.CS2ASDSLEditor.class;
	}
