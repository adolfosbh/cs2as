		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPropagationDefAccess().getAlternatives_1(), "rule__PropagationDef__Alternatives_1");
					put(grammarAccess.getExportDefAccess().getAlternatives_4_1(), "rule__ExportDef__Alternatives_4_1");
					...
					put(grammarAccess.getNamedElementDefAccess().getGroup_3_2(), "rule__NamedElementDef__Group_3_2__0");
					...
					put(grammarAccess.getElementsContribExpAccess().getGroup_2(), "rule__ElementsContribExp__Group_2__0");
					...
					put(grammarAccess.getOccludingDefAccess().getGroup_2(), "rule__OccludingDef__Group_2__0");
					put(grammarAccess.getPropagationDefAccess().getGroup(), "rule__PropagationDef__Group__0");
					put(grammarAccess.getPropagationDefAccess().getGroup_1_0(), "rule__PropagationDef__Group_1_0__0");
					put(grammarAccess.getPropagationDefAccess().getGroup_1_0_2(), "rule__PropagationDef__Group_1_0_2__0");
					put(grammarAccess.getPropagationDefAccess().getGroup_1_1(), "rule__PropagationDef__Group_1_1__0");
					put(grammarAccess.getPropagationDefAccess().getGroup_1_1_1(), "rule__PropagationDef__Group_1_1_1__0");
					put(grammarAccess.getPropagationDefAccess().getGroup_1_1_1_1(), "rule__PropagationDef__Group_1_1_1_1__0");
					put(grammarAccess.getExportDefAccess().getGroup(), "rule__ExportDef__Group__0");
					put(grammarAccess.getExportDefAccess().getGroup_2(), "rule__ExportDef__Group_2__0");
					put(grammarAccess.getExportDefAccess().getGroup_4(), "rule__ExportDef__Group_4__0");
					...
					put(grammarAccess.getNamedElementDefAccess().getQualificationAssignment_3_1(), "rule__NamedElementDef__QualificationAssignment_3_1");
					put(grammarAccess.getNamedElementDefAccess().getQualificationAssignment_3_2_1(), "rule__NamedElementDef__QualificationAssignment_3_2_1");
					put(grammarAccess.getQualificationDefAccess().getQualifiedClassAssignment_0(), "rule__QualificationDef__QualifiedClassAssignment_0");
					put(grammarAccess.getQualificationDefAccess().getContributionAssignment_2(), "rule__QualificationDef__ContributionAssignment_2");
					put(grammarAccess.getElementsContribExpAccess().getFollowingAssignment_0(), "rule__ElementsContribExp__FollowingAssignment_0");
					put(grammarAccess.getElementsContribExpAccess().getExpressionAssignment_1(), "rule__ElementsContribExp__ExpressionAssignment_1");
					put(grammarAccess.getElementsContribExpAccess().getTypeFilterAssignment_2_1(), "rule__ElementsContribExp__TypeFilterAssignment_2_1");
					put(grammarAccess.getScopeDefAccess().getSameScopeAssignment_0_1(), "rule__ScopeDef__SameScopeAssignment_0_1");
					put(grammarAccess.getScopeDefAccess().getAlsoExportsAssignment_1(), "rule__ScopeDef__AlsoExportsAssignment_1");
					put(grammarAccess.getScopeDefAccess().getContibutionAssignment_2(), "rule__ScopeDef__ContibutionAssignment_2");
					put(grammarAccess.getScopeDefAccess().getContibutionAssignment_3_1(), "rule__ScopeDef__ContibutionAssignment_3_1");
					put(grammarAccess.getScopeDefAccess().getOccludingDefsAssignment_4(), "rule__ScopeDef__OccludingDefsAssignment_4");
					put(grammarAccess.getScopeDefAccess().getPropagationDefAssignment_5(), "rule__ScopeDef__PropagationDefAssignment_5");
					put(grammarAccess.getOccludingDefAccess().getContibutionAssignment_1(), "rule__OccludingDef__ContibutionAssignment_1");
					put(grammarAccess.getOccludingDefAccess().getContibutionAssignment_2_1(), "rule__OccludingDef__ContibutionAssignment_2_1");
					put(grammarAccess.getPropagationDefAccess().getExceptionPropertiesAssignment_1_0_2_1(), "rule__PropagationDef__ExceptionPropertiesAssignment_1_0_2_1");
					put(grammarAccess.getPropagationDefAccess().getPropagatingPropertiesAssignment_1_1_1_0(), "rule__PropagationDef__PropagatingPropertiesAssignment_1_1_1_0");
					put(grammarAccess.getPropagationDefAccess().getPropagatingPropertiesAssignment_1_1_1_1_1(), "rule__PropagationDef__PropagatingPropertiesAssignment_1_1_1_1_1");
					put(grammarAccess.getExportDefAccess().getContibutionAssignment_1(), "rule__ExportDef__ContibutionAssignment_1");
					put(grammarAccess.getExportDefAccess().getContibutionAssignment_2_1(), "rule__ExportDef__ContibutionAssignment_2_1");
					put(grammarAccess.getExportDefAccess().getOccludingDefsAssignment_3(), "rule__ExportDef__OccludingDefsAssignment_3");
					put(grammarAccess.getExportDefAccess().getAcceptingAllAssignment_4_1_0(), "rule__ExportDef__AcceptingAllAssignment_4_1_0");
					put(grammarAccess.getExportDefAccess().getAcceptingElementAssignment_4_1_1(), "rule__ExportDef__AcceptingElementAssignment_4_1_1");
