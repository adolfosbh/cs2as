		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getInputAccess().getPropRefAssignment_3(), "rule__Input__PropRefAssignment_3");
					...
					put(grammarAccess.getProviderAccess().getStatementsAssignment_2(), "rule__Provider__StatementsAssignment_2");
