		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getScopeDefAccess().getContributingPropertyAssignment_2(), "rule__ScopeDef__ContributingPropertyAssignment_2");
					put(grammarAccess.getScopeDefAccess().getTypeFilterAssignment_3_1(), "rule__ScopeDef__TypeFilterAssignment_3_1");
					put(grammarAccess.getScopeDefAccess().getPropagatingAllAssignment_4_1_0(), "rule__ScopeDef__PropagatingAllAssignment_4_1_0");
					put(grammarAccess.getScopeDefAccess().getPropagatingNextsAssignment_4_1_1(), "rule__ScopeDef__PropagatingNextsAssignment_4_1_1");
					put(grammarAccess.getScopeDefAccess().getPropagatingPropertiesAssignment_4_1_2_0(), "rule__ScopeDef__PropagatingPropertiesAssignment_4_1_2_0");
					put(grammarAccess.getScopeDefAccess().getPropagatingPropertiesAssignment_4_1_2_1_1(), "rule__ScopeDef__PropagatingPropertiesAssignment_4_1_2_1_1");
