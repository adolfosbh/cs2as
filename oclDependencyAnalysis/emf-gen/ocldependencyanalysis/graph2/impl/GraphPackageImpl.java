...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	 ...
	 * @see ocldependencyanalysis.graph2.GraphPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EOperation getEdge__HashCode() {
	 ...
	 * @generated
	 */
	public EOperation getEdge__Equals__Object() {
	...
	public void createPackageContents() {
		...
		createEOperation(edgeEClass, EDGE___HASH_CODE);
		createEOperation(edgeEClass, EDGE___EQUALS__OBJECT);
	...
	public void initializePackageContents() {
		...
		initEReference(getNode_Incoming(), this.getEdge(), this.getEdge_To(), "incoming", null, 0, -1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getNode_Outgoing(), this.getEdge(), this.getEdge_From(), "outgoing", null, 0, -1, Node.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEdge_To(), this.getNode(), this.getNode_Incoming(), "to", null, 1, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEdge_From(), this.getNode(), this.getNode_Outgoing(), "from", null, 1, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEOperation(getEdge__HashCode(), ecorePackage.getEInt(), "hashCode", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getEdge__Equals__Object(), ecorePackage.getEBoolean(), "equals", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, thePivotPackage.getObject(), "object", 0, 1, IS_UNIQUE, IS_ORDERED);
