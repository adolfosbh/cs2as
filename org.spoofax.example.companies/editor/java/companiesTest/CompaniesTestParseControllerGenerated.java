...
public class CompaniesTestParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("CompaniesTest");
  ...
  { 
    CompaniesTestParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CompaniesTestParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CompaniesTestParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CompaniesTestParseControllerGenerated.class);
    }
  ...
  { 
    return CompaniesTestParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
