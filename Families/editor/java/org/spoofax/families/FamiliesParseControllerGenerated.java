...
public class FamiliesParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Families");
  ...
  { 
    FamiliesParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = FamiliesParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = FamiliesParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(FamiliesParseControllerGenerated.class);
    }
  ...
  { 
    return FamiliesParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
