...
public class Delphi_qvtp_qvtcas extends AbstractCS2ASTransformer
{
    ...
    public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull CollectionTypeId SET_CLSSid_declSection = TypeId.SET.getSpecializedId(CLSSid_declSection);
    ...
    public static final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull CollectionTypeId SET_CLSSid_interfaceDecl = TypeId.SET.getSpecializedId(CLSSid_interfaceDecl);
    ...
    private static final @NonNull ClassId[] classIndex2classId = new @NonNull ClassId[]{
        ...
        CLSSid_assignmentStmnt,         // 3 => assignmentStmnt
        CLSSid_block,                   // 4 => block
        CLSSid_callStmnt,               // 5 => callStmnt
        CLSSid_caseSelector,            // 6 => caseSelector
        CLSSid_caseStmt,                // 7 => caseStmt
        CLSSid_constExpr,               // 8 => constExpr
        CLSSid_constantDecl,            // 9 => constantDecl
        CLSSid_declSection,             // 10 => declSection
        CLSSid_designator,              // 11 => designator
        CLSSid_expression,              // 12 => expression
        CLSSid_factor,                  // 13 => factor
        CLSSid_file,                    // 14 => file
        CLSSid_ident,                   // 15 => ident
        CLSSid_ifStmt,                  // 16 => ifStmt
        CLSSid_implementationSection,   // 17 => implementationSection
        CLSSid_interfaceDecl,           // 18 => interfaceDecl
    ...
    private final static int @NonNull [] @NonNull [] classIndex2allClassIndexes = new int @NonNull [] @NonNull [] {
        {0,8},                  // 0 : ConstExp -> {ConstExp,constExpr}
        {1,8},                  // 1 : MultipleConstExp -> {MultipleConstExp,constExpr}
        {2,8},                  // 2 : RecordConstExp -> {RecordConstExp,constExpr}
        {3,30},                 // 3 : assignmentStmnt -> {assignmentStmnt,unlabelledStatement}
        {4},                    // 4 : block -> {block}
        {5,30},                 // 5 : callStmnt -> {callStmnt,unlabelledStatement}
        {6},                    // 6 : caseSelector -> {caseSelector}
        {7,30},                 // 7 : caseStmt -> {caseStmt,unlabelledStatement}
        {8},                    // 8 : constExpr -> {constExpr}
        {9},                    // 9 : constantDecl -> {constantDecl}
        {10},                   // 10 : declSection -> {declSection}
        {11},                   // 11 : designator -> {designator}
        {12},                   // 12 : expression -> {expression}
        {13,12},                // 13 : factor -> {factor,expression}
        {14},                   // 14 : file -> {file}
        {15},                   // 15 : ident -> {ident}
        {16,30},                // 16 : ifStmt -> {ifStmt,unlabelledStatement}
        {17},                   // 17 : implementationSection -> {implementationSection}
        {18},                   // 18 : interfaceDecl -> {interfaceDecl}
        {19},                   // 19 : interfaceSection -> {interfaceSection}
        {20,10},                // 20 : labelDeclSection -> {labelDeclSection,declSection}
        {21},                   // 21 : mainRule -> {mainRule}
        {22},                   // 22 : mulOp -> {mulOp}
        {23,10},                // 23 : procedureDecl -> {procedureDecl,declSection}
        {24,12},                // 24 : relExp -> {relExp,expression}
        {25},                   // 25 : statement -> {statement}
        {26,30},                // 26 : tryStmt -> {tryStmt,unlabelledStatement}
        {27},                   // 27 : type -> {type}
        {28},                   // 28 : typeDecl -> {typeDecl}
        {29,14},                // 29 : unit -> {unit,file}
        {30},                   // 30 : unlabelledStatement -> {unlabelledStatement}
        {31},                   // 31 : varDecl -> {varDecl}
        {32,30}                 // 32 : withStmt -> {withStmt,unlabelledStatement}
    };
    ...
    protected class CACHE_exprList_createActualParams extends AbstractEvaluationOperation
    {
        ...
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull exprList self_0 = (/*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull exprList)sourceAndArgumentValues[0];
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            @SuppressWarnings("null")
            final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<expression> exps = self_0.getExps();
        ...
        public org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull exprList self_0) {
    ...
    protected class CACHE_MultipleId_extract extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull MultipleId self_1 = (/*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull MultipleId)sourceAndArgumentValues[0];
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            @SuppressWarnings("null")
            final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<String> id = self_1.getId();
        ...
        public String evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull MultipleId self_1) {
    ...
    protected class CACHE_ReservedId_extract extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ReservedId self_2 = (/*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ReservedId)sourceAndArgumentValues[0];
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
        ...
        public String evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ReservedId self_2) {
    ...
    protected class CACHE_MineID_extract extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull MineID self_3 = (/*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull MineID)sourceAndArgumentValues[0];
            final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable String first = self_3.getFirst();
            return first;
        }
        
        public String evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull MineID self_3) {
    ...
    protected class CACHE_ident_extract extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ident self_4 = (/*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ident)sourceAndArgumentValues[0];
            return null;
        }
        
        public String evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ident self_4) {
    ...
    protected class CACHE_Visitable__lookupFunctionDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.NonNull Visitable self_5 = (/*@NonInvalid*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.NonNull Visitable)sourceAndArgumentValues[0];
            ...
            if (and) {
                ...
                final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue _lookupFunctionDefinition = INST_Visitable__lookupFunctionDefinition.evaluate(self_5, parentEnv_0, fName);
        ...
        @SuppressWarnings("unchecked")
        public org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.NonNull Visitable self_5, final /*@NonInvalid*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.Nullable LookupEnvironment env, final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable String fName) {
            return (org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_5, env, fName});
        }
    }
    ...
    protected class VCACHE_OclElement__unqualified_env_FunctionDefinition extends AbstractDispatchOperation
    {
        ...
        @SuppressWarnings("null")
        public org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment evaluate(final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_9, final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Object child_0) {
            return (org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_9, child_0});
        }
    }
    ...
    protected class CACHE_OclElement_parentEnv_FunctionDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_8 = (/*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object)sourceAndArgumentValues[0];
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Object parent = ClassifierOclContainerOperation.INSTANCE.evaluate(executor, self_8);
            ...
            if (eq) {
                ...
                final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment _unqualified_env_FunctionDefinition = INST_OclElement__unqualified_env_FunctionDefinition.evaluate(parent, self_8);
        ...
        @SuppressWarnings("null")
        public org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment evaluate(final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_8) {
            return (org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_8});
        }
    }
    ...
    protected class CACHE_CompilationUnit__unqualified_env_FunctionDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull CompilationUnit self_7 = (/*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull CompilationUnit)sourceAndArgumentValues[0];
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_astm_c_c_FunctionDefinition_0 = idResolver.getClass(CLSSid_FunctionDefinition, null);
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment self_18 = INST_OclElement_parentEnv_FunctionDefinition.evaluate(self_7);
            ...
            CTORid_parentEnv.initValue(symbol_0, self_18);
            @SuppressWarnings("null")
            final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<DefinitionObject> fragments = self_7.getFragments();
        ...
        public LookupEnvironment evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull CompilationUnit self_7, final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Object child) {
            return (LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_7, child});
        }
    }
    ...
    protected class CACHE_OclElement__unqualified_env_FunctionDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_9 = (/*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object)sourceAndArgumentValues[0];
            ...
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment parentEnv_FunctionDefinition = INST_OclElement_parentEnv_FunctionDefinition.evaluate(self_9);
    ...
    protected class CACHE_DelphiBlockStatement__unqualified_env_FunctionDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull DelphiBlockStatement self_10 = (/*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull DelphiBlockStatement)sourceAndArgumentValues[0];
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_astm_c_c_FunctionDefinition_0 = idResolver.getClass(CLSSid_FunctionDefinition, null);
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment self_18 = INST_OclElement_parentEnv_FunctionDefinition.evaluate(self_10);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Property CTORid_parentEnv = idResolver.getProperty(PROPid_parentEnv);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_lookup_c_c_LookupEnvironment_0 = idResolver.getClass(CLSSid_LookupEnvironment, null);
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment symbol_0 = (LookupEnvironment)TYP_lookup_c_c_LookupEnvironment_0.createInstance();
            CTORid_parentEnv.initValue(symbol_0, self_18);
            @SuppressWarnings("null")
            final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<DefinitionObject> declarations = self_10.getDeclarations();
        ...
        public LookupEnvironment evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull DelphiBlockStatement self_10, final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Object child_1) {
            return (LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_10, child_1});
        }
    }
    ...
    protected class CACHE_OclElement_unqualified_env_FunctionDefinition extends AbstractEvaluationOperation
    {
        ...
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            ...
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment _unqualified_env_FunctionDefinition = INST_OclElement__unqualified_env_FunctionDefinition.evaluate(self_6, null);
            return _unqualified_env_FunctionDefinition;
        }
        
        @SuppressWarnings("null")
        public org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment evaluate(final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_6) {
            return (org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_6});
        }
    }
    ...
    protected class CACHE_Visitable__lookupVariableDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.NonNull Visitable self_11 = (/*@NonInvalid*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.NonNull Visitable)sourceAndArgumentValues[0];
            ...
            if (and) {
                ...
                final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue _lookupVariableDefinition = INST_Visitable__lookupVariableDefinition.evaluate(self_11, parentEnv_0, vName);
        ...
        @SuppressWarnings("unchecked")
        public org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.NonNull Visitable self_11, final /*@NonInvalid*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.Nullable LookupEnvironment env_0, final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable String vName) {
            return (org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_11, env_0, vName});
        }
    }
    ...
    protected class VCACHE_OclElement__unqualified_env_VariableDefinition extends AbstractDispatchOperation
    {
        ...
        @SuppressWarnings("null")
        public org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment evaluate(final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_15, final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Object child_3) {
            return (org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_15, child_3});
        }
    }
    ...
    protected class CACHE_OclElement_parentEnv_VariableDefinition extends AbstractEvaluationOperation
    {
        ...
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Object parent = ClassifierOclContainerOperation.INSTANCE.evaluate(executor, self_14);
            final /*@NonInvalid*/ boolean eq = parent == null;
            /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment symbol_1;
            if (eq) {
                final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_lookup_c_c_LookupEnvironment_0 = idResolver.getClass(CLSSid_LookupEnvironment, null);
                ...
                final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment _unqualified_env_VariableDefinition = INST_OclElement__unqualified_env_VariableDefinition.evaluate(parent, self_14);
        ...
        @SuppressWarnings("null")
        public org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment evaluate(final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_14) {
            return (org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_14});
        }
    }
    ...
    protected class CACHE_DelphiBlockStatement__unqualified_env_VariableDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull DelphiBlockStatement self_13 = (/*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull DelphiBlockStatement)sourceAndArgumentValues[0];
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_astm_c_c_VariableDefinition_0 = idResolver.getClass(CLSSid_VariableDefinition, null);
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment self_18 = INST_OclElement_parentEnv_VariableDefinition.evaluate(self_13);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Property CTORid_parentEnv = idResolver.getProperty(PROPid_parentEnv);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_lookup_c_c_LookupEnvironment_0 = idResolver.getClass(CLSSid_LookupEnvironment, null);
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment symbol_0 = (LookupEnvironment)TYP_lookup_c_c_LookupEnvironment_0.createInstance();
            CTORid_parentEnv.initValue(symbol_0, self_18);
            @SuppressWarnings("null")
            final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<DefinitionObject> declarations = self_13.getDeclarations();
            final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue BOXED_declarations = idResolver.createOrderedSetOfAll(ORD_CLSSid_DefinitionObject, declarations);
        ...
        public LookupEnvironment evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull DelphiBlockStatement self_13, final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Object child_2) {
            return (LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_13, child_2});
        }
    }
    ...
    protected class CACHE_CompilationUnit__unqualified_env_VariableDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull CompilationUnit self_16 = (/*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull CompilationUnit)sourceAndArgumentValues[0];
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_astm_c_c_VariableDefinition_0 = idResolver.getClass(CLSSid_VariableDefinition, null);
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment self_18 = INST_OclElement_parentEnv_VariableDefinition.evaluate(self_16);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Property CTORid_parentEnv = idResolver.getProperty(PROPid_parentEnv);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_lookup_c_c_LookupEnvironment_0 = idResolver.getClass(CLSSid_LookupEnvironment, null);
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment symbol_0 = (LookupEnvironment)TYP_lookup_c_c_LookupEnvironment_0.createInstance();
            CTORid_parentEnv.initValue(symbol_0, self_18);
            @SuppressWarnings("null")
            final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<DefinitionObject> fragments = self_16.getFragments();
            final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue BOXED_fragments = idResolver.createOrderedSetOfAll(ORD_CLSSid_DefinitionObject, fragments);
        ...
        public LookupEnvironment evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull CompilationUnit self_16, final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.Nullable Object child_4) {
    ...
    protected class CACHE_OclElement__unqualified_env_VariableDefinition extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_15 = (/*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object)sourceAndArgumentValues[0];
            ...
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment parentEnv_VariableDefinition = INST_OclElement_parentEnv_VariableDefinition.evaluate(self_15);
    ...
    protected class CACHE_OclElement_unqualified_env_VariableDefinition extends AbstractEvaluationOperation
    {
        ...
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            ...
            final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment _unqualified_env_VariableDefinition = INST_OclElement__unqualified_env_VariableDefinition.evaluate(self_12, null);
            return _unqualified_env_VariableDefinition;
        }
        
        @SuppressWarnings("null")
        public org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment evaluate(final /*@NonInvalid*/ java.lang.@org.eclipse.jdt.annotation.NonNull Object self_12) {
            return (org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_12});
        }
    }
    ...
    protected class CACHE_identList_extract extends AbstractEvaluationOperation
    {
        @Override
        public @Nullable Object basicEvaluate(@NonNull Executor executor, @NonNull TypedElement caller, @Nullable Object @NonNull [] sourceAndArgumentValues) {
            @SuppressWarnings("null") final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull identList self_17 = (/*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull identList)sourceAndArgumentValues[0];
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            @SuppressWarnings("null")
            final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<ident> ids = self_17.getIds();
        ...
        public String evaluate(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull identList self_17) {
            return (String)evaluationCache.getCachedEvaluationResult(this, caller, new @Nullable Object[]{self_17});
        }
    }
     ...
     *   ;
     * ::ji_constantDecl : Set(delphi::constantDecl)[*|1]var _'\u00ABdeclSection\u00BB' : Set(delphi::declSection) := leftCS.objectsOfKind(delphi::declSection)
     *   ;
     * ::ji_declSection : Set(delphi::declSection)[*|1]var _'\u00ABdesignator\u00BB' : Set(delphi::designator) := leftCS.objectsOfKind(delphi::designator)
     *   ;
     ...
     *   ;
     * ::ji_file : Set(delphi::file)[*|1]var _'\u00ABident\u00BB' : Set(delphi::ident) := leftCS.objectsOfKind(delphi::ident)
     *   ;
     ...
     *   ;
     * ::ji_implementationSection : Set(delphi::implementationSection)[*|1]var _'\u00ABinterfaceDecl\u00BB' : Set(delphi::interfaceDecl) := leftCS.objectsOfKind(delphi::interfaceDecl)
     *   ;
     * ::ji_interfaceDecl : Set(delphi::interfaceDecl)[*|1]var _'\u00ABinterfaceSection\u00BB' : Set(delphi::interfaceSection) := leftCS.objectsOfKind(delphi::interfaceSection)
     *   ;
     ...
     * lConstantDecl iterates loop0 : delphi::constantDecl[1];
     * }}
     *   for loop0 : delphi::declSection[1] in ji_declSection {
     *     call m_declSection_ast0 {
     * lDeclSection iterates loop0 : delphi::declSection[1];
     * }}
     *   for loop0 : delphi::designator[1] in ji_designator {
     ...
     * lImplementationSection iterates loop0 : delphi::implementationSection[1];
     * }}
     *   for loop0 : delphi::interfaceDecl[1] in ji_interfaceDecl {
     *     call m_interfaceDecl_ast0 {
     * lInterfaceDecl iterates loop0 : delphi::interfaceDecl[1];
     * }}
     *   for loop0 : delphi::interfaceSection[1] in ji_interfaceSection {
    ...
    protected boolean MAP___root__()  {
        try {
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_ConstExp, models[0/*leftCS*/], TYP_delphi_c_c_ConstExp_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_0 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_MultipleConstExp, models[0/*leftCS*/], TYP_delphi_c_c_MultipleConstExp_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_1 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_RecordConstExp, models[0/*leftCS*/], TYP_delphi_c_c_RecordConstExp_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_2 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_assignmentStmnt, models[0/*leftCS*/], TYP_delphi_c_c_assignmentStmnt_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_3 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_block, models[0/*leftCS*/], TYP_delphi_c_c_block_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_4 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_callStmnt, models[0/*leftCS*/], TYP_delphi_c_c_callStmnt_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_5 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_caseSelector, models[0/*leftCS*/], TYP_delphi_c_c_caseSelector_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_6 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_caseStmt, models[0/*leftCS*/], TYP_delphi_c_c_caseStmt_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_7 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_constExpr, models[0/*leftCS*/], TYP_delphi_c_c_constExpr_1);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_8 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_constantDecl, models[0/*leftCS*/], TYP_delphi_c_c_constantDecl_0);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_delphi_c_c_declSection_1 = idResolver.getClass(CLSSid_declSection, null);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_9 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_declSection, models[0/*leftCS*/], TYP_delphi_c_c_declSection_1);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_delphi_c_c_ident_0 = idResolver.getClass(CLSSid_ident, null);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_14 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_ident, models[0/*leftCS*/], TYP_delphi_c_c_ident_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_15 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_ifStmt, models[0/*leftCS*/], TYP_delphi_c_c_ifStmt_0);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_16 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_implementationSection, models[0/*leftCS*/], TYP_delphi_c_c_implementationSection_0);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_delphi_c_c_interfaceDecl_1 = idResolver.getClass(CLSSid_interfaceDecl, null);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_17 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_interfaceDecl, models[0/*leftCS*/], TYP_delphi_c_c_interfaceDecl_1);
            ...
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_delphi_c_c_type_0 = idResolver.getClass(CLSSid_type, null);
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull SetValue objectsOfKind_26 = ModelObjectsOfKindOperation.INSTANCE.evaluate(executor, SET_CLSSid_type, models[0/*leftCS*/], TYP_delphi_c_c_type_0);
            ...
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ConstExp iterator : ValueUtil.typedIterable(ConstExp.class, objectsOfKind)) {
                ji_ConstExp.add(iterator);
            }
            final SetValue.@NonNull Accumulator ji_MultipleConstExp = createUnenforcedSetAccumulatorValue(SET_CLSSid_MultipleConstExp);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull MultipleConstExp iterator_0 : ValueUtil.typedIterable(MultipleConstExp.class, objectsOfKind_0)) {
                ji_MultipleConstExp.add(iterator_0);
            }
            final SetValue.@NonNull Accumulator ji_RecordConstExp = createUnenforcedSetAccumulatorValue(SET_CLSSid_RecordConstExp);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull RecordConstExp iterator_1 : ValueUtil.typedIterable(RecordConstExp.class, objectsOfKind_1)) {
                ji_RecordConstExp.add(iterator_1);
            }
            final SetValue.@NonNull Accumulator ji_assignmentStmnt = createUnenforcedSetAccumulatorValue(SET_CLSSid_assignmentStmnt);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull assignmentStmnt iterator_2 : ValueUtil.typedIterable(assignmentStmnt.class, objectsOfKind_2)) {
                ji_assignmentStmnt.add(iterator_2);
            }
            final SetValue.@NonNull Accumulator ji_block = createUnenforcedSetAccumulatorValue(SET_CLSSid_block);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull block iterator_3 : ValueUtil.typedIterable(block.class, objectsOfKind_3)) {
                ji_block.add(iterator_3);
            }
            final SetValue.@NonNull Accumulator ji_callStmnt = createUnenforcedSetAccumulatorValue(SET_CLSSid_callStmnt);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull callStmnt iterator_4 : ValueUtil.typedIterable(callStmnt.class, objectsOfKind_4)) {
                ji_callStmnt.add(iterator_4);
            }
            final SetValue.@NonNull Accumulator ji_caseSelector = createUnenforcedSetAccumulatorValue(SET_CLSSid_caseSelector);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull caseSelector iterator_5 : ValueUtil.typedIterable(caseSelector.class, objectsOfKind_5)) {
                ji_caseSelector.add(iterator_5);
            }
            final SetValue.@NonNull Accumulator ji_caseStmt = createUnenforcedSetAccumulatorValue(SET_CLSSid_caseStmt);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull caseStmt iterator_6 : ValueUtil.typedIterable(caseStmt.class, objectsOfKind_6)) {
                ji_caseStmt.add(iterator_6);
            }
            final SetValue.@NonNull Accumulator ji_constExpr = createUnenforcedSetAccumulatorValue(SET_CLSSid_constExpr);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull constExpr iterator_7 : ValueUtil.typedIterable(constExpr.class, objectsOfKind_7)) {
                ji_constExpr.add(iterator_7);
            }
            final SetValue.@NonNull Accumulator ji_constantDecl = createUnenforcedSetAccumulatorValue(SET_CLSSid_constantDecl);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull constantDecl iterator_8 : ValueUtil.typedIterable(constantDecl.class, objectsOfKind_8)) {
                ji_constantDecl.add(iterator_8);
            }
            final SetValue.@NonNull Accumulator ji_declSection = createUnenforcedSetAccumulatorValue(SET_CLSSid_declSection);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull declSection iterator_9 : ValueUtil.typedIterable(declSection.class, objectsOfKind_9)) {
                ji_declSection.add(iterator_9);
            }
            ...
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ident iterator_14 : ValueUtil.typedIterable(ident.class, objectsOfKind_14)) {
                ji_ident.add(iterator_14);
            }
            final SetValue.@NonNull Accumulator ji_ifStmt = createUnenforcedSetAccumulatorValue(SET_CLSSid_ifStmt);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ifStmt iterator_15 : ValueUtil.typedIterable(ifStmt.class, objectsOfKind_15)) {
                ji_ifStmt.add(iterator_15);
            }
            ...
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull implementationSection iterator_16 : ValueUtil.typedIterable(implementationSection.class, objectsOfKind_16)) {
                ji_implementationSection.add(iterator_16);
            }
            final SetValue.@NonNull Accumulator ji_interfaceDecl = createUnenforcedSetAccumulatorValue(SET_CLSSid_interfaceDecl);
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull interfaceDecl iterator_17 : ValueUtil.typedIterable(interfaceDecl.class, objectsOfKind_17)) {
                ji_interfaceDecl.add(iterator_17);
            }
            ...
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ifStmt loop0_10 : ValueUtil.typedIterable(ifStmt.class, ji_ifStmt)) {
                MAP_m_IfStatement_ifStmt(loop0_10);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull implementationSection loop0_11 : ValueUtil.typedIterable(implementationSection.class, ji_implementationSection)) {
                MAP_m_DelphiImplementationSection_implementationSectio(loop0_11);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull interfaceSection loop0_12 : ValueUtil.typedIterable(interfaceSection.class, ji_interfaceSection)) {
                MAP_m_DelphiInterfaceSection_interfaceSection(loop0_12);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull labelDeclSection loop0_13 : ValueUtil.typedIterable(labelDeclSection.class, ji_labelDeclSection)) {
                MAP_m_LabelDefinition_labelDeclSection(loop0_13);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull mainRule loop0_14 : ValueUtil.typedIterable(mainRule.class, ji_mainRule)) {
                MAP_m_Project_mainRule(loop0_14);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull mulOp loop0_15 : ValueUtil.typedIterable(mulOp.class, ji_mulOp)) {
                MAP_m_BinaryExpression_mulOp(loop0_15);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull procedureDecl loop0_16 : ValueUtil.typedIterable(procedureDecl.class, ji_procedureDecl)) {
                MAP_m_FunctionDefinition_procedureDecl(loop0_16);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull relExp loop0_17 : ValueUtil.typedIterable(relExp.class, ji_relExp)) {
                MAP_m_BinaryExpression_relExp(loop0_17);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull tryStmt loop0_18 : ValueUtil.typedIterable(tryStmt.class, ji_tryStmt)) {
                MAP_m_TryStatement_tryStmt(loop0_18);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull typeDecl loop0_19 : ValueUtil.typedIterable(typeDecl.class, ji_typeDecl)) {
                MAP_m_TypeDefinition_typeDecl(loop0_19);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull unit loop0_20 : ValueUtil.typedIterable(unit.class, ji_unit)) {
                MAP_m_DelphiUnit_unit(loop0_20);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull varDecl loop0_21 : ValueUtil.typedIterable(varDecl.class, ji_varDecl)) {
                MAP_m_VariableDefinition_varDecl(loop0_21);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull withStmt loop0_22 : ValueUtil.typedIterable(withStmt.class, ji_withStmt)) {
                MAP_m_DelphiWithStatement_withStmt(loop0_22);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ConstExp loop0_23 : ValueUtil.typedIterable(ConstExp.class, ji_ConstExp)) {
                MAP_m_ConstExp_ast_exp(loop0_23);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull MultipleConstExp loop0_24 : ValueUtil.typedIterable(MultipleConstExp.class, ji_MultipleConstExp)) {
                MAP_m_MultipleConstExp_ast_exps(loop0_24);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull RecordConstExp loop0_25 : ValueUtil.typedIterable(RecordConstExp.class, ji_RecordConstExp)) {
                MAP_m_RecordConstExp_ast_exps(loop0_25);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull assignmentStmnt loop0_26 : ValueUtil.typedIterable(assignmentStmnt.class, ji_assignmentStmnt)) {
                MAP_m_assignmentStmnt_ast_designator_exp(loop0_26);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull block loop0_27 : ValueUtil.typedIterable(block.class, ji_block)) {
                MAP_m_block_ast_declSect(loop0_27);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull block loop0_28 : ValueUtil.typedIterable(block.class, ji_block)) {
                MAP_m_block_ast_compound(loop0_28);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull callStmnt loop0_29 : ValueUtil.typedIterable(callStmnt.class, ji_callStmnt)) {
                MAP_m_callStmnt_args_ast_designator(loop0_29);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull caseSelector loop0_30 : ValueUtil.typedIterable(caseSelector.class, ji_caseSelector)) {
                MAP_m_caseSelector_ast_stmt(loop0_30);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull caseSelector loop0_31 : ValueUtil.typedIterable(caseSelector.class, ji_caseSelector)) {
                MAP_m_caseSelector_ast_labels(loop0_31);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull caseStmt loop0_32 : ValueUtil.typedIterable(caseStmt.class, ji_caseStmt)) {
                MAP_m_caseStmt_ast_cases(loop0_32);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull caseStmt loop0_33 : ValueUtil.typedIterable(caseStmt.class, ji_caseStmt)) {
                MAP_m_caseStmt_ast_expression(loop0_33);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull constExpr loop0_34 : ValueUtil.typedIterable(constExpr.class, ji_constExpr)) {
                MAP_m_constExpr_ast0(loop0_34);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull constantDecl loop0_35 : ValueUtil.typedIterable(constantDecl.class, ji_constantDecl)) {
                MAP_m_constantDecl_ast_id(loop0_35);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull constantDecl loop0_36 : ValueUtil.typedIterable(constantDecl.class, ji_constantDecl)) {
                MAP_m_constantDecl_ast_const(loop0_36);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull declSection loop0_37 : ValueUtil.typedIterable(declSection.class, ji_declSection)) {
                MAP_m_declSection_ast0(loop0_37);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull designator loop0_38 : ValueUtil.typedIterable(designator.class, ji_designator)) {
                MAP_m_designator_ast_subpart(loop0_38);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull designator loop0_39 : ValueUtil.typedIterable(designator.class, ji_designator)) {
                MAP_m_designator_ast_subpart_1(loop0_39);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull expression loop0_40 : ValueUtil.typedIterable(expression.class, ji_expression)) {
                MAP_m_expression_ast0(loop0_40);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull factor loop0_41 : ValueUtil.typedIterable(factor.class, ji_factor)) {
                MAP_m_factor_ast_expList(loop0_41);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull factor loop0_42 : ValueUtil.typedIterable(factor.class, ji_factor)) {
                MAP_m_factor_ast_designator(loop0_42);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull factor loop0_43 : ValueUtil.typedIterable(factor.class, ji_factor)) {
                MAP_m_factor_ast_number(loop0_43);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull factor loop0_44 : ValueUtil.typedIterable(factor.class, ji_factor)) {
                MAP_m_factor_ast_string(loop0_44);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull file loop0_45 : ValueUtil.typedIterable(file.class, ji_file)) {
                MAP_m_file_ast0(loop0_45);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ident loop0_46 : ValueUtil.typedIterable(ident.class, ji_ident)) {
                MAP_m_ident_ast0(loop0_46);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ifStmt loop0_47 : ValueUtil.typedIterable(ifStmt.class, ji_ifStmt)) {
                MAP_m_ifStmt_ast_condition(loop0_47);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ifStmt loop0_48 : ValueUtil.typedIterable(ifStmt.class, ji_ifStmt)) {
                MAP_m_ifStmt_ast_else(loop0_48);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ifStmt loop0_49 : ValueUtil.typedIterable(ifStmt.class, ji_ifStmt)) {
                MAP_m_ifStmt_ast_then(loop0_49);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull implementationSection loop0_50 : ValueUtil.typedIterable(implementationSection.class, ji_implementationSection)) {
                MAP_m_implementationSection_ast_declSect(loop0_50);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull interfaceDecl loop0_51 : ValueUtil.typedIterable(interfaceDecl.class, ji_interfaceDecl)) {
                MAP_m_interfaceDecl_ast0(loop0_51);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull interfaceSection loop0_52 : ValueUtil.typedIterable(interfaceSection.class, ji_interfaceSection)) {
                MAP_m_interfaceSection_ast_interfaceDecl(loop0_52);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull mainRule loop0_53 : ValueUtil.typedIterable(mainRule.class, ji_mainRule)) {
                MAP_m_mainRule_ast_file(loop0_53);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull procedureDecl loop0_54 : ValueUtil.typedIterable(procedureDecl.class, ji_procedureDecl)) {
                MAP_m_procedureDecl_ast_block(loop0_54);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull procedureDecl loop0_55 : ValueUtil.typedIterable(procedureDecl.class, ji_procedureDecl)) {
                MAP_m_procedureDecl_ast_heading(loop0_55);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull designator loop0_56 : ValueUtil.typedIterable(designator.class, ji_designator)) {
                MAP_m_designator_ast(loop0_56);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull designator loop0_57 : ValueUtil.typedIterable(designator.class, ji_designator)) {
                MAP_m_designator_ast_1(loop0_57);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull relExp loop0_58 : ValueUtil.typedIterable(relExp.class, ji_relExp)) {
                MAP_m_relExp_ast_left(loop0_58);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull relExp loop0_59 : ValueUtil.typedIterable(relExp.class, ji_relExp)) {
                MAP_m_relExp_ast(loop0_59);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull relExp loop0_60 : ValueUtil.typedIterable(relExp.class, ji_relExp)) {
                MAP_m_relExp_ast_right(loop0_60);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull statement loop0_61 : ValueUtil.typedIterable(statement.class, ji_statement)) {
                MAP_m_statement_ast_statement(loop0_61);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull tryStmt loop0_62 : ValueUtil.typedIterable(tryStmt.class, ji_tryStmt)) {
                MAP_m_tryStmt_ast_final(loop0_62);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull tryStmt loop0_63 : ValueUtil.typedIterable(tryStmt.class, ji_tryStmt)) {
                MAP_m_tryStmt_ast(loop0_63);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull typeDecl loop0_64 : ValueUtil.typedIterable(typeDecl.class, ji_typeDecl)) {
                MAP_m_typeDecl_ast_id(loop0_64);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull type loop0_65 : ValueUtil.typedIterable(type.class, ji_type)) {
                MAP_m_type_ast0(loop0_65);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull unit loop0_66 : ValueUtil.typedIterable(unit.class, ji_unit)) {
                MAP_m_unit_ast_implementationSect(loop0_66);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull unit loop0_67 : ValueUtil.typedIterable(unit.class, ji_unit)) {
                MAP_m_unit_ast_interfaceSect(loop0_67);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull unit loop0_68 : ValueUtil.typedIterable(unit.class, ji_unit)) {
                MAP_m_unit_ast_id(loop0_68);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull unlabelledStatement loop0_69 : ValueUtil.typedIterable(unlabelledStatement.class, ji_unlabelledStatement)) {
                MAP_m_unlabelledStatement_ast0(loop0_69);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull varDecl loop0_70 : ValueUtil.typedIterable(varDecl.class, ji_varDecl)) {
                MAP_m_varDecl_ast_type(loop0_70);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull varDecl loop0_71 : ValueUtil.typedIterable(varDecl.class, ji_varDecl)) {
                MAP_m_varDecl_ast_idList(loop0_71);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull withStmt loop0_72 : ValueUtil.typedIterable(withStmt.class, ji_withStmt)) {
                MAP_m_withStmt_ast_stmt(loop0_72);
            }
            for (org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull withStmt loop0_73 : ValueUtil.typedIterable(withStmt.class, ji_withStmt)) {
                MAP_m_withStmt_ast_vars(loop0_73);
            }
    ...
    protected boolean MAP_m_assignmentStmnt_ast_designator_exp(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull assignmentStmnt lAssignmentStmnt_0)  {
        try {
            ...
            if (symbol_1) {
                ...
                final /*@Thrown*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.Nullable Visitable ast_1 = exp.getAst();
                final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_astm_c_c_Expression_0 = idResolver.getClass(CLSSid_Expression, null);
                final /*@Thrown*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull Expression oclAsType_0 = ClassUtil.nonNullState((Expression)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, ast_1, TYP_astm_c_c_Expression_0));
                ...
                final /*@Thrown*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull NameReference oclAsType_1 = ClassUtil.nonNullState((NameReference)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, ast_0, TYP_astm_c_c_NameReference_0));
     ...
     * var aDelphiBlockStatement : astm::DelphiBlockStatement[1] := ast.oclAsType(astm::DelphiBlockStatement)
     *   ;
     * var ast1 : astm::Visitable[?] := declSect.ast;
     * var aDefinitionObject : astm::DefinitionObject[1] := ast1.oclAsType(astm::DefinitionObject)
     *   ;
     * var OrderedSet : OrderedSet(astm::DefinitionObject)[*|1] := OrderedSet{aDefinitionObject
     *   };
     * set aDelphiBlockStatement.declarations := OrderedSet;
     * 
     */
    protected boolean MAP_m_block_ast_declSect(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull block lBlock_1)  {
        try {
            ...
            if (symbol_0) {
                ...
                final /*@Thrown*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.Nullable Visitable ast_0 = declSect.getAst();
                ...
                final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue OrderedSet = ValueUtil.createOrderedSetOfEach(ORD_CLSSid_DefinitionObject, oclAsType_0);
                // mapping statements
                final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<DefinitionObject> ECORE_OrderedSet = ((IdResolver.IdResolverExtension)idResolver).ecoreValueOfAll(DefinitionObject.class, OrderedSet);
                oclAsType.getDeclarations().addAll(ECORE_OrderedSet);
    ...
    /**
     * 
     * map m_declSection_ast0 in Delphi_qvtp_qvtcas {
     * 
     *   guard:leftCS lDeclSection  : delphi::declSection[1];
     * check lDeclSection.oclIsTypeOf(delphi::declSection);
     * set lDeclSection.ast := null;
     * 
     */
    protected boolean MAP_m_declSection_ast0(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull declSection lDeclSection)  {
        try {
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_delphi_c_c_declSection_0_0 = idResolver.getClass(CLSSid_declSection, null);
            final /*@NonInvalid*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, lDeclSection, TYP_delphi_c_c_declSection_0_0).booleanValue();
            /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean symbol_2;
            if (oclIsTypeOf) {
                // mapping statements
                lDeclSection.setAst(null);
                final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean m_declSection_ast0 = ValueUtil.TRUE_VALUE;
                symbol_2 = m_declSection_ast0;
            }
            else {
                symbol_2 = ValueUtil.FALSE_VALUE;
            }
            ...
            return handleExecutionFailure("MAP_m_declSection_ast0", e);
        }
    }
    ...
    protected boolean MAP_m_designator_ast(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull designator lDesignator_1)  {
        try {
            ...
            if (symbol_0) {
                ...
                final /*@Thrown*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.Nullable Visitable self_19 = lDesignator_1.getAst();
                if (self_19 == null) {
                    throw throwNull(lDesignator_1, "Null where non-null value required");
                }
                ...
                final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment unqualified_env_FunctionDefinition = INST_OclElement_unqualified_env_FunctionDefinition.evaluate(self_19);
                final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue foundFunctionDefinition = INST_Visitable__lookupFunctionDefinition.evaluate(self_19, unqualified_env_FunctionDefinition, fName_0);
                ...
                if (ne) {
                    ...
                    final /*@Thrown*/ org.xtext.example.delphi.astm.lookup.@org.eclipse.jdt.annotation.NonNull LookupEnvironment unqualified_env_VariableDefinition = INST_OclElement_unqualified_env_VariableDefinition.evaluate(self_19);
                    final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue foundVariableDefinition = INST_Visitable__lookupVariableDefinition.evaluate(self_19, unqualified_env_VariableDefinition, vName_0);
    ...
    protected boolean MAP_m_designator_ast_1(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull designator lDesignator_2)  {
        try {
            ...
            if (symbol_0) {
                ...
                final /*@Thrown*/ org.xtext.example.delphi.astm.util.@org.eclipse.jdt.annotation.Nullable Visitable self_19 = lDesignator_2.getAst();
                if (self_19 == null) {
                    throw throwNull(lDesignator_2, "Null where non-null value required");
                }
    ...
    /**
     * 
     * map m_ident_ast0 in Delphi_qvtp_qvtcas {
     * guard:leftCS lIdent  : delphi::ident[1];
     * set lIdent.ast := null;
     * 
     */
    protected boolean MAP_m_ident_ast0(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull ident lIdent)  {
        try {
            // mapping statements
            lIdent.setAst(null);
            final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean m_ident_ast0 = ValueUtil.TRUE_VALUE;
            return m_ident_ast0;
        } catch (Throwable e) {
            return handleExecutionFailure("MAP_m_ident_ast0", e);
        }
    }
    ...
    /**
     * 
     * map m_interfaceDecl_ast0 in Delphi_qvtp_qvtcas {
     * 
     *   guard:leftCS lInterfaceDecl  : delphi::interfaceDecl[1];
     * check lInterfaceDecl.oclIsTypeOf(delphi::interfaceDecl);
     * set lInterfaceDecl.ast := null;
     * 
     */
    protected boolean MAP_m_interfaceDecl_ast0(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull interfaceDecl lInterfaceDecl)  {
        try {
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_delphi_c_c_interfaceDecl_0_0 = idResolver.getClass(CLSSid_interfaceDecl, null);
            final /*@NonInvalid*/ boolean oclIsTypeOf = OclAnyOclIsTypeOfOperation.INSTANCE.evaluate(executor, lInterfaceDecl, TYP_delphi_c_c_interfaceDecl_0_0).booleanValue();
            /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean symbol_2;
            if (oclIsTypeOf) {
                // mapping statements
                lInterfaceDecl.setAst(null);
                final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean m_interfaceDecl_ast0 = ValueUtil.TRUE_VALUE;
                symbol_2 = m_interfaceDecl_ast0;
            }
            else {
                symbol_2 = ValueUtil.FALSE_VALUE;
            }
            ...
            return handleExecutionFailure("MAP_m_interfaceDecl_ast0", e);
        }
    }
     ...
     *     _'1_'.ast.oclAsType(astm::DefinitionObject))
     *   ;
     * var asOrderedSet : OrderedSet(astm::DefinitionObject) := _'\u00ABcollect\u00BB'->asOrderedSet();
     * set aDelphiInterfaceSection.fragments := asOrderedSet;
     * 
     */
    protected boolean MAP_m_interfaceSection_ast_interfaceDecl(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull interfaceSection lInterfaceSection_0)  {
        try {
            ...
            if (symbol_0) {
                ...
                final /*@Thrown*/ org.eclipse.ocl.pivot.values.@org.eclipse.jdt.annotation.NonNull OrderedSetValue asOrderedSet = CollectionAsOrderedSetOperation.INSTANCE.evaluate(collect);
                // mapping statements
                final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<DefinitionObject> ECORE_asOrderedSet = ((IdResolver.IdResolverExtension)idResolver).ecoreValueOfAll(DefinitionObject.class, asOrderedSet);
                oclAsType.getFragments().addAll(ECORE_asOrderedSet);
    ...
    /**
     * 
     * map m_relExp_ast in Delphi_qvtp_qvtcas {
     * guard:leftCS lRelExp  : delphi::relExp[1];
     * var relOp : Class[1] := delphi::relOp;
     ...
     * 
     */
    protected boolean MAP_m_relExp_ast(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull relExp lRelExp_0)  {
        try {
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_delphi_c_c_relOp_0 = idResolver.getClass(CLSSid_relOp, null);
            ...
            if (symbol_0) {
                ...
                final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable String op = ((relOp)TYP_delphi_c_c_relOp_0).getOp();
                ...
                final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean m_relExp_ast = ValueUtil.TRUE_VALUE;
                raw_ast = m_relExp_ast;
            }
            else {
                raw_ast = ValueUtil.FALSE_VALUE;
            }
            ...
            return handleExecutionFailure("MAP_m_relExp_ast", e);
        }
    }
     ...
     * 
     */
    protected boolean MAP_m_relExp_ast_left(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull relExp lRelExp_1)  {
        try {
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            ...
            if (symbol_0) {
                ...
                final /*@Thrown*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.Nullable expression left = lRelExp_1.getLeft();
                final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_astm_c_c_BinaryExpression_0 = idResolver.getClass(CLSSid_BinaryExpression, null);
                final /*@Thrown*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull BinaryExpression oclAsType = ClassUtil.nonNullState((BinaryExpression)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, ast, TYP_astm_c_c_BinaryExpression_0));
                if (left == null) {
    ...
    /**
     * 
     * map m_tryStmt_ast in Delphi_qvtp_qvtcas {
     * 
     *   guard:leftCS lTryStmt  : delphi::tryStmt[1];
     * var stmtList : Class[1] := delphi::stmtList;
     ...
     * 
     */
    protected boolean MAP_m_tryStmt_ast(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull tryStmt lTryStmt_0)  {
        try {
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_delphi_c_c_stmtList_0 = idResolver.getClass(CLSSid_stmtList, null);
            ...
            if (symbol_0) {
                ...
                @SuppressWarnings("null")
                final /*@Thrown*/ java.util.@org.eclipse.jdt.annotation.NonNull List<statement> statments = ((stmtList)TYP_delphi_c_c_stmtList_0).getStatments();
                ...
                final /*@Thrown*/ java.lang.@org.eclipse.jdt.annotation.Nullable Boolean m_tryStmt_ast = ValueUtil.TRUE_VALUE;
                raw_ast = m_tryStmt_ast;
            }
            else {
                raw_ast = ValueUtil.FALSE_VALUE;
            }
            ...
            return handleExecutionFailure("MAP_m_tryStmt_ast", e);
        }
    }
     ...
     * 
     */
    protected boolean MAP_m_tryStmt_ast_final(final /*@NonInvalid*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.NonNull tryStmt lTryStmt_1)  {
        try {
            final /*@NonInvalid*/ org.eclipse.ocl.pivot.ids.@org.eclipse.jdt.annotation.NonNull IdResolver idResolver = executor.getIdResolver();
            ...
            if (symbol_0) {
                ...
                final /*@Thrown*/ org.xtext.example.delphi.delphi.@org.eclipse.jdt.annotation.Nullable stmtList symbol_1 = lTryStmt_1.getFinal();
                final /*@NonInvalid*/ org.eclipse.ocl.pivot.@org.eclipse.jdt.annotation.NonNull Class TYP_astm_c_c_TryStatement_0 = idResolver.getClass(CLSSid_TryStatement, null);
                final /*@Thrown*/ org.xtext.example.delphi.astm.@org.eclipse.jdt.annotation.NonNull TryStatement oclAsType = ClassUtil.nonNullState((TryStatement)OclAnyOclAsTypeOperation.INSTANCE.evaluate(executor, ast, TYP_astm_c_c_TryStatement_0));
                if (symbol_1 == null) {
