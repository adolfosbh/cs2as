...
public class InternalDelphiLexer extends Lexer {
    ...
    public final void mRULE_SLASH() throws RecognitionException {
        try {
            // InternalDelphi.g:10622:21: ( '\\\\' )
            // InternalDelphi.g:10622:23: '\\\\'
            {
            match('\\'); 
    ...
    public final void mRULE_QUOTE() throws RecognitionException {
        try {
            // InternalDelphi.g:10624:21: ( '\\'' )
            // InternalDelphi.g:10624:23: '\\''
            {
            match('\''); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10626:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' | RULE_SLASH | '-' )* )
            // InternalDelphi.g:10626:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' | RULE_SLASH | '-' )*
            {
            ...
            // InternalDelphi.g:10626:35: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '$' | '#' | RULE_SLASH | '-' )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_DOUBLEQUOTE() throws RecognitionException {
        try {
            // InternalDelphi.g:10628:27: ( '\"' )
            // InternalDelphi.g:10628:29: '\"'
            {
            match('\"'); 
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            int _type = RULE_HEX;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10634:10: ( ( '+' | '-' )? '0' ( 'x' | 'X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+ )
            // InternalDelphi.g:10634:12: ( '+' | '-' )? '0' ( 'x' | 'X' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
            {
            // InternalDelphi.g:10634:12: ( '+' | '-' )?
            int alt4=2;
            ...
            // InternalDelphi.g:10634:37: ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )+
            int cnt5=0;
            loop5:
            do {
                int alt5=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10636:10: ( ( '+' | '-' )? ( '0' .. '9' )+ )
            // InternalDelphi.g:10636:12: ( '+' | '-' )? ( '0' .. '9' )+
            {
            // InternalDelphi.g:10636:12: ( '+' | '-' )?
            int alt6=2;
    ...
    public final void mRULE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10638:14: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalDelphi.g:10638:16: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalDelphi.g:10638:21: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
    ...
    public final void mRULE_MORECOMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10640:18: ( '{' ( options {greedy=false; } : . )* '}' )
            // InternalDelphi.g:10640:20: '{' ( options {greedy=false; } : . )* '}'
            {
            match('{'); 
            // InternalDelphi.g:10640:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_LINE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10642:19: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalDelphi.g:10642:21: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalDelphi.g:10642:26: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalDelphi.g:10644:9: ( ( ' ' | '\\r' | '\\t' | '\\f' | '\\n' ) )
            // InternalDelphi.g:10644:11: ( ' ' | '\\r' | '\\t' | '\\f' | '\\n' )
            {
