 ...
 * @generated
 */
public class DelphiSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case DelphiPackage.PROGRAM:
      {
        ...
        if (result == null) result = casemainRule(program);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DelphiPackage.UNIT:
      {
        ...
        if (result == null) result = casemainRule(unit);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DelphiPackage.PACKAGE_DECL:
      {
        ...
        if (result == null) result = casemainRule(packageDecl);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case DelphiPackage.LIBRARY:
      {
        ...
        if (result == null) result = casemainRule(library);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case DelphiPackage.MUL_EXP:
      {
        ...
        if (result == null) result = caseterm(mulExp);
        if (result == null) result = casesimpleExpression(mulExp);
        if (result == null) result = caseexpression(mulExp);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      {
        SimpleExp simpleExp = (SimpleExp)theEObject;
        T result = caseSimpleExp(simpleExp);
        if (result == null) result = caseconstExpr(simpleExp);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Simple Exp</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Simple Exp</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseSimpleExp(SimpleExp object)
  {
    return null;
  }
