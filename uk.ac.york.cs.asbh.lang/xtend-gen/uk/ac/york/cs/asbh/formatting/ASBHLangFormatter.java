 ...
 * generated by Xtext
 */
package uk.ac.york.cs.asbh.formatting;
...
public class ASBHLangFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private ASBHLangGrammarAccess _aSBHLangGrammarAccess;
  
  @Override
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._aSBHLangGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._aSBHLangGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._aSBHLangGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._aSBHLangGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._aSBHLangGrammarAccess.getML_COMMENTRule();
